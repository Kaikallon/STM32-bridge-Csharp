    ...
    public static class CanDbCSharpCodeGeneration
    {
        ...
        public static string GenerateMessageCode(CanMessageType canMessageType, int o, int n = 4)
        {
            ...
            foreach (var CanSignalType in canMessageType.Signals.Values)
            {
                ...
                stringBuilder.AppendLine(n * (2 + o), $"tempValue  {CanSignalType.GetSubtractionOperator()};");
                stringBuilder.AppendLine(n * (2 + o), $"tempValue  {CanSignalType.GetDivisionOperator()};");
                ...
                stringBuilder.AppendLine(n * (1 + o), $"{{");
                stringBuilder.AppendLine(n * (2 + o), $"// Scale and offset value according to signal secification");
                stringBuilder.AppendLine(n * (2 + o), $"value {CanSignalType.GetMultiplierOperator()};");
